...
async def add_to_queue_or_play(chat_id, song_info, requested_by):
    ...
    # 🔥 YENİ: KUYRUK LİMİTİ (1 Çalan + 5 Bekleyen = Toplam 6 Sınırı)
    if len(music_queue[chat_id]) >= 6:
        safe_delete(song_info["file_path"]) # İndirilen dosyayı sil, RAM'i koru
        return "FULL", None
...
# 🔥 YENİ: BELİRLİ BİR SIRADAKİ ŞARKIYI SİLME FONKSİYONU
